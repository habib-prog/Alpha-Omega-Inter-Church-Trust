      ...
      <section className="bg-amber-800 backdrop-blur-md py-36">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="ml-16 sm:ml-0 sm:text-start inline-block py-1 px-3 rounded-full bg-white/60 text-black font-bold backdrop-blur-md text-sm mb-3 sm:mb-6  ">
                THE ALPHA OMEGA INITIATIVE
              </h2>
              <h1 className="text-center sm:text-start text-5xl md:text-6xl lg:text-7xl w-full font-secondery font-bold mb-6">
                ...
                Channges <br className="block" />
                <span className="text-white block">a Life.</span>
              </h1>
              <p className="text-center sm:text-start text-lg md:text-xl text-[#1B1B1B]/80 mb-8 max-w-lg">
                {" "}
                Join us in building sustainable communities where clean water,
                education, and hope flow freely. Your support plants the seeds
                for a better tomorrow.Donate Now
              </p>
              <div className="flex flex-col sm:flex-row gap-5">
                <Link
                  to="/"
                  className="inline-flex  bg-[#E87461] items-center justify-center rounded-full font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#FEFAE0] text-white hover:bg-[#D66350] px-8 py-4 text-lg group gap-2.5"
                >
                ...
                >
                  {" "}
                  <IoPlayCircleOutline className="text-2xl" /> Learn Our Story
                </Link>
              </div>
            </div>
